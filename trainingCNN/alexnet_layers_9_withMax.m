layers = [...
	...
	convolution2dLayer(3, 256, 'NumChannels', 192, 'Name', 'conv6', 'Padding', [1 1], 'BiasLearnRateFactor', 0)
	reluLayer('Name', 'relu6')
    maxPooling2dLayer(3, 'Stride', 2, 'Name', 'pool4')
	...
	fullyConnectedLayer(2614, 'Name', 'fc9', 'BiasLearnRateFactor', 0)
