...
layers = [...
	...
	convolution2dLayer(5, 256*2, 'Name', 'conv2', 'Padding', [2 2],  'BiasLearnRateFactor', 0)
	reluLayer('Name', 'relu2')
	crossChannelNormalizationLayer(5, 'Name', 'norm2')	
	maxPooling2dLayer(3, 'Stride', 2, 'Name', 'pool2')
	    
	convolution2dLayer(3, 384*2, 'Name', 'conv3', 'Padding', [1 1], 'BiasLearnRateFactor', 0)
	reluLayer('Name', 'relu3')
    
	convolution2dLayer(3, 384*2, 'Name', 'conv4', 'Padding', [1 1], 'BiasLearnRateFactor', 0)
	reluLayer('Name', 'relu4')
    
	convolution2dLayer(3, 256*2, 'Name', 'conv5', 'Padding', [1 1], 'BiasLearnRateFactor', 0)
