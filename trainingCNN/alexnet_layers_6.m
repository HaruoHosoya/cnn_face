layers = [...
	...
	convolution2dLayer(3, 256, 'NumChannels', 192, 'Name', 'conv3', 'Padding', [1 1], 'BiasLearnRateFactor', 0)
	reluLayer('Name', 'relu3')
    
	maxPooling2dLayer(3, 'Stride', 2, 'Name', 'pool3')
    
	fullyConnectedLayer(4096, 'Name', 'fc4', 'BiasLearnRateFactor', 0)
	reluLayer('Name', 'relu4')
	dropoutLayer('Name', 'drop4')
	fullyConnectedLayer(4096, 'Name', 'fc5', 'BiasLearnRateFactor', 0)
	reluLayer('Name', 'relu5')
	dropoutLayer('Name', 'drop5')
	fullyConnectedLayer(2614, 'Name', 'fc6', 'BiasLearnRateFactor', 0)
